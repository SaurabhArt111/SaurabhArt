...
const styles = {
  ...
  "fallbackPreview": "pmodal-fallback-preview",
  "fallbackMark": "pmodal-fallback-mark",
  "fallbackText": "pmodal-fallback-text",
};

/* Featured Work — cover click opens the case study here, embedded live via
   iframe when a URL exists. Rendered through a portal straight onto
   <body>, so none of the Work section's transforms / overflow:hidden /
   perspective can ever clip or reposition it. */
export default function ProjectModal({ project, onClose }) {
  ...
  useEffect(() => {
    ...
    /* lock the page + pause Lenis while the modal is open */
            ...
            >
              {project.preview ? (
                <div className={styles.fallbackPreview}>
                  <WorkPreview variant={project.preview} accent={project.accent} />
                </div>
              ) : (
