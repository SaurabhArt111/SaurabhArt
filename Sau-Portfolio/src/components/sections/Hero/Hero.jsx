...
const styles = {
  ...
  "particleAccent": "hero-particle-accent",
  "head": "hero-head",
  "kicker": "hero-kicker",
  "h1": "hero-h1",
  "row": "hero-row",
  ...
  "ctas": "hero-ctas",
  "play": "hero-play",
  "stageRow": "hero-stage-row",
  "side": "hero-side",
  "sideL": "hero-side-l",
  "sideR": "hero-side-r",
  "statCard": "hero-stat-card",
  "statIcon": "hero-stat-icon",
  "statNum": "hero-stat-num",
  "statLabel": "hero-stat-label",
  "stage": "hero-stage",
  "arch": "hero-arch",
  "archLine": "hero-arch-line",
  "portrait": "hero-portrait",
  "chipLayer": "hero-chip-layer",
  "chip": "hero-chip",
  "chipWide": "hero-chip-wide",
  "annot": "hero-annot",
  "stackLabel": "hero-stack-label",
  "labelArrow": "hero-label-arrow",
  "scrollCue": "hero-scroll-cue",
  "cueArrow": "hero-cue-arrow",
};

const STATS_LEFT = [
  { n: 10, suffix: "+", key: "stat.projects", icon: "/images/icons/projects.png" },
  { n: 3, suffix: "", key: "stat.disciplines", icon: "/images/icons/years.png" },
];
const STATS_RIGHT = [
  { n: 14, suffix: "", key: "stat.tools", icon: "/images/icons/countries.png" },
  { n: 100, suffix: "%", key: "stat.selfdriven", icon: "/images/icons/satisfaction.png" },
];
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.call(
        () => {
          gsap.utils.toArray(`.${styles.statNum}`).forEach((numEl) => {
      ...
      /* ---------- Idle life ---------- */
      gsap.utils.toArray(`.${styles.particle}`).forEach((p) => {
        gsap.to(p, {
      ...
      gsap.utils.toArray(`.${styles.glow}`).forEach((g, i) => {
        gsap.to(g, {
          opacity: 0.55,
          duration: 5.5,
          yoyo: true,
      ...
      <div className={styles.stageRow}>
        ...
        <div className={styles.stage}>
          ...
          <img
            ...
            alt="Saurabh Maurya — Artist, Designer & Developer"
            width={554}
            height={573}
            data-depth="0.03"
          />
