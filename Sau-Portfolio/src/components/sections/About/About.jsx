...
const styles = {
  ...
  "metric": "about-metric",
  "metricNum": "about-metric-num",
  "metricStatic": "about-metric-static",
  "metricLabel": "about-metric-label",
  "edu": "about-edu",
  "next": "about-next",
};
...
const METRICS = [
  { value: "10+", count: 10, suffix: "+", key: "about.m1" },
  { value: "3", count: 3, key: "about.m2" },
  { value: "14", count: 14, key: "about.m3" },
  { value: "MERN", count: null, key: "about.m4" },
];
    ...
    const ctx = gsap.context(() => {
      ...
      if (band) {
        ...
        ScrollTrigger.create({
          ...
          once: true,
          onEnter: () => {
            gsap.utils.toArray("[data-metric-count]").forEach((numEl) => {
